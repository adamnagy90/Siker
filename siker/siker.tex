...
Instant szárírott élesztő esetén a hasonló faktor \num{0.33}, ezt a receptek száraz összetevőihez keverhetjük hidratálás nélkül, ne lepődjünk meg azonban, ha az "éledés" apró lokális foltokban fog megjelenni a tésztában.

\input{./siker/signature_pogacsa}
\input{./siker/kifli_perec}
\input{./siker/hamburger}
